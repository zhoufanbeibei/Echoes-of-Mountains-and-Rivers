...
namespace InfinityCode.RealWorldTerrain.Generators
{
    public class RealWorldTerrainArcGISElevationGenerator : RealWorldTerrainElevationGenerator
    {
        ...
        private void Download()
        {
            ...
            for (int x = 0; x < s; x++)
            {
                ...
                for (int y = 0; y < s; y++)
                {
                    ...
                    double sx, sy, ex, ey;
                    RealWorldTerrainGeo.TileToLatLong(tsx, tsy, 20, out sx, out sy);
                    RealWorldTerrainGeo.TileToLatLong(tex, tey, 20, out ex, out ey);
        ...
        public static void Init()
        {
            ...
            double dx, dy;
            RealWorldTerrainMath.DistanceBetweenPoints(sx, sy, ex, ey, out dx, out dy);
            ...
            RealWorldTerrainGeo.LatLongToTile(sx, sy, 20, out stx, out sty);
            RealWorldTerrainGeo.LatLongToTile(ex, ey, 20, out etx, out ety);
            ...
            RealWorldTerrainGeo.TileToLatLong(stx, sty, 20, out cx1, out cy1);
            RealWorldTerrainGeo.TileToLatLong(etx, ety, 20, out cx2, out cy2);
