...
namespace InfinityCode.RealWorldTerrain.Phases
{
    public class RealWorldTerrainGenerateTerrainsPhase : RealWorldTerrainPhase
    {
        ...
        private static RealWorldTerrainItem AddTerrainItem(int x, int y, double x1, double y1, double x2, double y2, Vector3 size, Vector3 scale, double maxElevation, double minElevation, GameObject GO)
        {
            ...
            RealWorldTerrainGeo.MercatToLatLong(x1, y1, out tlx, out tly);
            RealWorldTerrainGeo.MercatToLatLong(x2, y2, out brx, out bry);
        ...
        public override void Enter()
        {
            ...
            RealWorldTerrainGeo.LatLongToMercat(ref fromX, ref fromY);
            RealWorldTerrainGeo.LatLongToMercat(ref toX, ref toY);
        ...
        public override void Start()
        {
            ...
            if (prefs.sizeType == 0 || prefs.sizeType == 2)
            {
                ...
                sizeZ = RealWorldTerrainGeo.EARTH_RADIUS * Math.Acos(scfY * sctY + ccfY * cctY);
            }
            else if (prefs.sizeType == 1)
            {
                sizeX = Math.Abs(rangeX / 360 * RealWorldTerrainGeo.EQUATOR_LENGTH);
                sizeZ = Math.Abs(rangeY / 360 * RealWorldTerrainGeo.EQUATOR_LENGTH);
            }

            maxElevation = RealWorldTerrainGeo.MAX_ELEVATION;
            minElevation = -RealWorldTerrainGeo.MAX_ELEVATION;
            ...
            RealWorldTerrainGeo.LatLongToMercat(fromX, fromY, out mx1, out my1);
            RealWorldTerrainGeo.LatLongToMercat(toX, toY, out mx2, out my2);
            ...
            if (prefs.useAnchor)
            {
                RealWorldTerrainGeo.LatLongToMercat(prefs.anchorLongitude, prefs.anchorLatitude, out mx1, out my1);
