    ...
    public static class RealWorldTerrainBuildR3Generator
    {
        ...
        private static void CreateBuilding(RealWorldTerrainContainer globalContainer, RealWorldTerrainOSMWay way)
        {
            ...
            for (int i = 0; i < points.Count; i++)
            {
                ...
                float a1 = RealWorldTerrainMath.Angle2D(pp, p);
                float a2 = RealWorldTerrainMath.Angle2D(p, points[next]);
            ...
            float angle1 = RealWorldTerrainMath.Angle2D(points[southIndex], points[nextIndex]);
            float angle2 = RealWorldTerrainMath.Angle2D(points[southIndex], points[prevIndex]);
